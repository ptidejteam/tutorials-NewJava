...
public class Client {
	public static void main(final String[] args)
		...
		// Impossible to control the access to AKernelInterfaceImplementation.
		// AKernelInterfaceImplementation is either public or package/protected 
		// but then invisible from classes in other packages, e.g., "internal".
