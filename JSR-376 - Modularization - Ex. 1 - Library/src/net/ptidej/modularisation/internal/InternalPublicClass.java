package net.ptidej.modularisation.internal;
...
public class InternalPublicClass {
	public static void main(final String[] args)
		...
		// Impossible to control the access to AKernelInterfaceImplementation from Malicious.
		// AKernelInterfaceImplementation is either public or package/protected but then
		// invisible from classes in other legitimate packages!
